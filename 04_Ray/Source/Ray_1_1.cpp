...
{
	v2Pos1.x = 0.0f;  v2Pos1.y = 0.0f;				// キャラクタの初期位置　①
...
int MoveCharacter( void )						// 毎フレーム呼ばれる
{
	...
	v2Pos1.x = 0.0f;                    v2Pos1.y = 0.0f;
	v2Pos2.x = ( float )CursorPos.x;    v2Pos2.y = ( float )CursorPos.y;
	v2Pos3.x =             + v2Side.x;  v2Pos3.y =             + v2Side.y;
