...
int InitShapes( void )						// 最初に１回だけ呼ばれる
{
	...
	faFanB.r1 = 100.0f;
	faFanB.r2 = 200.0f;
	faFanB.vx1 = faFanB.r1 * cosf( faFanB.fAngle1 );  faFanB.vy1 = faFanB.r1 * sinf( faFanB.fAngle1 );
	faFanB.vx2 = faFanB.r1 * cosf( faFanB.fAngle2 );  faFanB.vy2 = faFanB.r1 * sinf( faFanB.fAngle2 );
